  ...
  headers: {
    ...
    init: function() {
            ...
            success: function(file,response) {
              if(response.error){
                $("#myDropzone").hide();
                $(".lol").html("<p>Maximum 20 images are allowed.</p>")
