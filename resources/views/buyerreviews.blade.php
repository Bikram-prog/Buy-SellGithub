...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <form action="/buyerreviewaction" method="post">

      {{ csrf_field() }}

      <input type="hidden" name="rating_val" id="rating_val_id" value="">

      <div class="form-group">
        <textarea style="border-radius: 10px; height: 100px;" name="review" rows="3" cols="50" placeholder="Write a review..." class="form-control"></textarea>
      </div>
