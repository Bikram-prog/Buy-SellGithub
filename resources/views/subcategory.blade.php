...
<div class="container-xl mt-4">
        <div class="row">
            <div class="col-12">
                <h2 style="font-weight: bold; font-size: 22px; margin-bottom: 20px;"><a href="/category/{{ $cat_id }}/{{ $catetitle[0]->cate_title }}" style="text-decoration: none;">{{ $catetitle[0]->cate_title }}</a> >> {{ $subtitle }}</h2>
            </div>
            <div class="col-md-3">
            ...
            @endif
                ...
                <div class="card" style="padding: 20px;">
                    ...
                    <button type="submit" class="mt-2 btn btn-link">Filter</button>
              ...
              <div class="row">
                ...
                <div class="col-md-4 mt-2">
                  ...
                  @if(count($prodImg) > 0)
                    ...
                    @else
                            <a href="/p/{{ $user->prod_id }}"><img style="object-fit: cover; height: 300px;" src="{{asset('images')}}/{{ $user->pro_img_path }}" class="card-img-top" alt="name"></a>
                    @endif
                    <div class="card-body">
                      <h5 class="card-subtitle mb-2">{{ $catetitle[0]->cate_title }}</h5>
