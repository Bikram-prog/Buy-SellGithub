...
<div class="container">
     <div class="row">
          ...
          <div class="col-md-6">
               <form action='/prodvariationattribute' method="post">
                    {{ csrf_field() }}
          ...
          <div class="col-md-12">
               ...
               <a href="/sellerimgupld/{{ $id }}" style="border-radius: 25px; float: right;margin-left: 15px;" class="btn btn-dark">Skip</a>
               @endif

               @if(count($attributes) > 0)
               <a href="/variation/{{ $id }}" class="btn btn-danger" style="border-radius: 25px; float: right;">NEXT</a>
               @endif
          </div>
     </div>
     </div>
