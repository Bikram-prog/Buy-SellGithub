        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('stripeproduct.post') }}" method="post" class="require-validation"
                   ...
                   <input type="hidden" value="<?php echo "title"; ?>" name="prod_title">
                    ...
                    <input type="hidden" value="<?php echo Session::get('UserIds'); ?>" name="seller_id">
                        ...
                        <button class="btn btn-danger btn-lg btn-block" type="submit">Pay Now ($1)</button>
