        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="container mt-4">
                    <div class="row">
                        <div class="col-md-12">
                        <p><a class="btn btn-primary btn-lg" href="/addbuyeraddress" style="border-radius: 5px !important;"><i class="fas fa-plus"></i> Add new address</a></p>
                        @foreach($data as $add)
                        <form action="/buyerprimaryadd" method="POST">
                        {{ csrf_field() }}
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                        <a href="{{ url('buyereditaddress/'.$add->buyer_del_id)}}" class="btn btn-clear-danger"><i style="color: #f9ca24; font-size: 16px;" class="fas fa-edit"></i></a>
                                        <a onclick="return confirmdelete()" href="{{ url('deladdress/'.$add->buyer_del_id)}}" class="btn btn-clear-primary"><i style="color: #eb4d4b; font-size: 16px;" class="fas fa-trash"></i></a>
                                    </p>
                                </div>
                            </div>
