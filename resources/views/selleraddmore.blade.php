                     ...
                     <form name="add_name" id="add_name">  
                          <div class="table-responsive">  
                               <table class="table table-bordered" id="dynamic_field">  
                                    <tr>  
                                         <td><input type="text" name="extra[]" placeholder="Enter your Name" class="form-control name_list" /></td>  
...
<a href="/payment/<?php echo $prodid; ?>/<?php echo $prodtitle; ?>">Payment</a> 
@include('footer')
 ...
 $(document).ready(function(){  
      ...
      $(document).on('click', '.btn_remove', function(){  
       ...
       $('#submit').click(function(){            
           $.ajax({  
                url:"https://megabuy.online/selleraddmoreaction",  
                method:"POST",  
