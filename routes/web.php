...
Route::get('/test-products', function () {
    ...
    $products= SellerUser::with('products.product_image')->get();
...
Route::get('/composer', function () {
    ...
    try {
        ...
        $output=null;
        $retval=null;
        exec('composer require srmklive/PayPal', $output, $retval);
        return $output;
...
Route::middleware(['membersauth'])->group(function () {
    //
});
...
Route::get('/memberlogin','BuyerLoginController@viewMemberLogin');
Route::post('/memberloginaction','BuyerLoginController@memberLogin');
Route::get('/memberlogout','BuyerLoginController@logoutMember');

Route::get('/member','BuyerLoginController@viewMember');
...
Route::get('/reviewsandtestimonials','BuyerLoginController@viewReviewsAndTestimonials');
...
Route::get('/memberaddbuyeraddress','BuyerLoginController@viewMemberAddressForm');
Route::post('/editmemberloginaction','BuyerLoginController@addMemberAddress');
Route::get('/membermanageaddress','BuyerLoginController@viewMemberAddress');
...
Route::get('/memberorders','BuyerLoginController@viewMemberOrders');
...
Route::post('/memberprimaryadd', 'BuyerLoginController@makeMemberPrimaryAddress');
Route::get('/membereditaddress/{id}', 'BuyerLoginController@editMemberAddressForm');
Route::post('/editmemberaddressaction', 'BuyerLoginController@editMemberAddress');
Route::get('/memberdeladdress/{id}', 'BuyerLoginController@deleteMemberAddress');
...
Route::get('/m/{id}','homeAllProdController@memberProductDetails');
...
Route::get('/membercart', 'homeAllProdController@memberCart')->name('membercart');
Route::get('/memberremoveproduct/{id}', 'homeAllProdController@removeMember')->name('memberremoveproduct');
Route::post('/memberupdateproduct', 'homeAllProdController@updateMember')->name('memberupdateproduct');
Route::get('/membercheckout', 'homeAllProdController@memberCheckout');

Route::get('/paypal/success', 'homeAllProdController@paypalSuccess');
Route::get('/paypal/cancel', 'homeAllProdController@paypalCancel');
...
Route::post('memberstripe', 'homeAllProdController@memberStripePost')->name('memberstripe');
...
Route::get('/sellereditmeasurement/{id}', 'SellerDashboardController@editMeasurementForm');
Route::post('/editmeasurementaction', 'SellerDashboardController@editMeasurement');

Route::get('/selleraddmeasurement/{id}', 'SellerDashboardController@addMeasurementForm');
Route::post('/addmeasurementaction', 'SellerDashboardController@addMeasurement');
...
Route::get('/memberorderhistory', 'SellerDashboardController@memberOrderHistory');
...
Route::get('/filters/{text}', 'homeAllProdController@filtersView');
